...
Things to note:
	I have modified the TestView and TestControl classes by adding
	a function of my own so that I can have my own testing. I have
	not modified any of the given functions in these two classes
	though, so they're still the same as the ones provided in the
	default versions of these classes.