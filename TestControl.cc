...
void TestControl::launch(){
    ...
    while (choice!=0){
        ...
        switch(choice){
            ...
            case 6: personalTest(); break;
        }
    }
}

void TestControl::personalTest(){
    cout << "Making network" << endl;
    Network* network = new Network("Personal Test");

    initNetwork(network);
    if(network->removePodcast("Dogs")){
        cout << "removed podcast" << endl;
    }
    else{
        cout << "Couldn't remove podcast" << endl;
    }
    ...
    cout << "Making subscriber" << endl;
    Subscriber* sub = new Subscriber("Jeff", "9257");
    sub->print();
    ...
    cout << "Making episode" << endl;
    Episode* ep1 = new Episode();
    Episode* ep2 = new Episode("pod1", 4, "hey", "This is the content");
    ...
    Podcast* pod1 = new Podcast("Doggos", "Big Dog");
    Podcast* pod2 = new Podcast("Kitties", "Tired Cat");
    pod1->print();
    pod2->print();

    if(pod1->lessThan(*pod2)){
        cout << "true" << endl;
    }
    else{
        cout << "false" << endl;
    }
    if(pod2->lessThan(*pod1)){
        cout << "true" << endl;
    }
    else{
        cout << "false" << endl;
    }
    if(pod1->lessThan(*pod1)){
        cout << "true" << endl;
    }
    else{
        cout << "false" << endl;
